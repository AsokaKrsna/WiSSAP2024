    ...
    day2: {
        ...
        events: [
            ...
            
            {
                ...
                title: "Invited Talk  -  Diversity of Indian Spoken Languages and the Challenges Ahead",
                speaker: "Dr. Shyam S Agrawal",
                venue: "Peacock Hall",
                description: "<strong>Abstract: </strong>The talk briefly mentions the huge diversity of languages spoken in different parts of India including under resourced languages. The need to develop necessary resources and apply latest technological tools for their studies and hence to develop spoken language systems for various applications and communication with persons speaking other languages. It also briefly mentions the importance of basic perception and acoustic research to understand the properties of speech sounds and their use in developing speech systems.\
                <br>Various challenges ahead such as meticulous development of appropriate speech corpora, need for multi-lingual and multi model systems, emotions and sentiments analysis and localized application Systems are emphasized.\
                <br><br><strong>About Speaker: </strong>Dr. Shyam Sunder Agrawal is an eminent scientist and an Academician. He obtained Ph.D.in Physics (Electronics) in 1970 from Aligarah Muslim University, India. Taught Physics/ Electronics/ communication at AMU Aligarh , BITS Pilani and other institutions. He worked as a Research Scientist for about 40 years at the CEERI, Pilani. After superannuation, he was appointed as Emeritus Scientist of CSIR and also an Advisor to CDAC, Noida.\
                <br>He has worked as Guest Researcher at MIT, Cambridge with Prof. Ken Stevens, at UCLA with Prof. Peter Ladefoged, at Ohio State University with Prof. Mary Backman in U.S.A. and visited many universities and research institutions in USA, UK, France, Germany, Sweden, Italy, Japan, China, Korea and other Asian countries. He worked on the development of first High Quality Hindi speech using Klatt Synthesizer and Voice operated Wheel Chair. His major areas of research have been Speech Perception, Speech Synthesis, Speech/ Speaker recognition and Development of Speech Data Bases for Indian Languages. He has published/ presented about 300 research papers in National / International Journals and Conferences. Guided many Ph.D. and M.Tech Students. He has steered and executed many R&D projects sponsored/ funded by Govt. Of India, Nokia , ELDA, and other International Agencies.\
                <br>Received large no. of Hons. and Awards. He was awarded Senior Fulbright Fellowship, U.N.D.P Fellowship and Sr. East-West Centre Fellowship.\
                <br>He received Life Time Achievement awards from the IETE and Computer Society of India. He is a Distinguished Fellow of IETE, and fellow of CSI, ASI, ISPhS and other professional societies. Other awards include Sir C.V. Raman Award by Acoustical Society of India, Internationally Eminent Acoustician Award and Gold Medal from Acoustic Foundation and Acoustic Society of America, Honored to deliver Several memorial lectures such as B.D. Chaudhuri Memorial lecture, M. S. Narayanan Memorial lecture, Rais Ahmed Memorial lecture, Best project Awards by CEERI, Achut Menon Award and many other citations.\
                <br>He served as Board Member of the International Commission on Acoustics. President of the Acoustical Society of India and with several professional societies in the capacity of their vice president, and Council Members. He has been Country representative of O-COCOSDA, U-Star consortium & member of Indo-Japan Forum of NICT.\
                <br>He is currently working as Director General of KIIT Group of Institution and steering their Academic & Research programs in Institutions of Higher Learning and engaged in several national and international collaborative research projects and Advisor to various National and International Institutions."
            },
            {
                time: "10:30 a.m - 11:00 a.m",
